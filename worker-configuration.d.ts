/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8739eca6996543372bbfb2b3735ce505)
// Runtime types generated with workerd@1.20260903.1 2026-09-06 
interface __BaseEnv_Env {
	AUDIT_RECEIPTS: R2Bucket;
	DUSK_EVENTS: AnalyticsEngineDataset;
	DUSK_RUNTIME: DurableObjectNamespace /* DuskRuntimeDO */;
	REPLAY_GUARD: DurableObjectNamespace /* ReplayGuardDO */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/dusk-gateway/src/index");
		durableNamespaces: "DuskRuntimeDO" | "ReplayGuardDO";
	}
