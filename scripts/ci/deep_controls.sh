...
pip-licenses --allow-only='Apache Software License;Apache-2.0;BSD License;BSD-2-Clause;BSD-3-Clause;MIT;MIT License;MPL-2.0;Mozilla Public License 2.0 (MPL 2.0);Python Software Foundation License;ISC License (ISCL)'
