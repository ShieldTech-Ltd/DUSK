...
def test_vendored_evaluator_matches_the_canonical_package_source() -> None:
    repository = Path(__file__).resolve().parents[3]
    canonical = repository / "src/dusk/application/evaluator.py"
    vendored = repository / "examples/agent-action-monitor/src/dusk/application/evaluator.py"
